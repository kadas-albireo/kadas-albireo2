...
Taken from https://github.com/inasafe/inasafe/blob/develop/scripts/missing_translations.py
"""
...
if __name__ == '__main__':
    ...
    for locale in locales:
        relative_path = os.path.join('kadasrouting', 'i18n', 'kadasrouting_%s.ts' % locale)
