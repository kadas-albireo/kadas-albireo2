...
class Ui_EphemToolWidget(object):
    def setupUi(self, EphemToolWidget):
        ...
        self.gridLayout.addWidget(self.tabWidgetOutput, 4, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.labelPositionValue, 2, 1, 1, 3)

        self.retranslateUi(EphemToolWidget)
        self.tabWidgetOutput.setCurrentIndex(1)
    ...
    def retranslateUi(self, EphemToolWidget):
        ...
        self.label_2.setText(_translate("EphemToolWidget", "<html><head/><body><p><span style=\" font-weight:600;\">Calculate Ephemeris</span></p></body></html>"))
