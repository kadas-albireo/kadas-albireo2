...
void TestKadasAlternateGotoLocatorFilter::testGoto_data()
{
  ...
  QTest::newRow( "gmaps2" ) << QStringLiteral( "https://www.google.com/maps/@7.931768,80.8731272,688963m/data=!3m1!1e3" ) << Results( { { QObject::tr( "Go to 7.875°N 81.0149°E at scale 1:6.49572e+07" ), QgsPointXY( 81.0149, 7.8750 ) } } );
