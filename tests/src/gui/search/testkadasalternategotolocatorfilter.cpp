...
void TestKadasAlternateGotoLocatorFilter::testGoto_data()
{
  ...
  QTest::newRow( "gmaps2" ) << QStringLiteral( "https://www.google.com/maps/@7.931768,80.8731272,688963m/data=!3m1!1e3" ) << Results( { { QObject::tr( "Go to 7.931768°N 80.8731272°E at scale 1:6.45343e+07" ), QgsPointXY( 80.8731272, 7.931768 ) } } );
