if(TARGET nlohmann_json::nlohmann_json_unofficial)
  return()
endif()

set(WITH_INTERNAL_NLOHMANN_JSON TRUE CACHE BOOL "Activate internal nlohmann")
if(WITH_INTERNAL_NLOHMANN_JSON)
  # Create imported target nlohmann_json::nlohmann_json
  add_library(nlohmann_json::nlohmann_json_unofficial INTERFACE IMPORTED)
  
  set_target_properties(nlohmann_json::nlohmann_json_unofficial PROPERTIES
