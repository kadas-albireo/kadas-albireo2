...
foreach(_component ${QGIS_FIND_COMPONENTS})
  if(${_component} STREQUAL "Python")
    execute_process(COMMAND ${Python_EXECUTABLE} -c "import os;import qgis;print(os.path.dirname(qgis.__file__))" WORKING_DIRECTORY ${CMAKE_BINARY_DIR} OUTPUT_VARIABLE QGIS_PYTHON_MODULE_DIR COMMAND_ERROR_IS_FATAL ANY ECHO_ERROR_VARIABLE OUTPUT_STRIP_TRAILING_WHITESPACE)
