...
macro(_find_qgis_library _lib_name _component)
  if(NOT QGIS_${_component}_LIBRARY)
    ...
    mark_as_advanced(
      QGIS_${_component}_LIBRARY_RELEASE QGIS_${_component}_LIBRARY_DEBUG
    )
  endif()
  ...
  if(QGIS_${_component}_LIBRARY)
    ...
    if(NOT TARGET QGIS::${_component})
      ...
      set_target_properties(
        QGIS::${_component} PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
      )
...
foreach(_component ${QGIS_FIND_COMPONENTS})
  if(${_component} STREQUAL "Python")
    ...
    set_target_properties(
      QGIS::Python PROPERTIES PYTHON_MODULE_DIR ${QGIS_PYTHON_MODULE_DIR}
    )
  else()
