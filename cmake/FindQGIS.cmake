...
find_path(
  QGIS_INCLUDE_DIR qgis/qgis.h
  PATHS ${QGIS_ROOT}/include/
...
macro(_find_qgis_library _lib_name _component)
  if(NOT QGIS_${_component}_LIBRARY)
    ...
    mark_as_advanced(QGIS_${_component}_LIBRARY_RELEASE
                     QGIS_${_component}_LIBRARY_DEBUG)
  endif()
  ...
  if(QGIS_${_component}_LIBRARY)
    ...
    if(NOT TARGET QGIS::${_component})
      ...
      set_target_properties(QGIS::${_component}
                            PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "CXX")
      target_include_directories(
        QGIS::${_component}
        INTERFACE "${QGIS_INCLUDE_DIR}"
                  "${QGIS_INCLUDE_DIR}/qgis" # Required for includes in qgis
                                             # .sip files
      )
      ...
      # if(EXISTS "${QGIS_${_component}_LIBRARY_RELEASE}") set_property(TARGET
      # QGIS::${_component} APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
      # set_target_properties(QGIS::${_component} PROPERTIES
      # IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
      # IMPORTED_LOCATION_RELEASE "${QGIS_${_component}_LIBRARY_RELEASE}")
      # endif() if(EXISTS "${QGIS_${_component}_LIBRARY_DEBUG}")
      # set_property(TARGET QGIS::${_component} APPEND PROPERTY
      # IMPORTED_CONFIGURATIONS DEBUG) set_target_properties(QGIS::${_component}
      # PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
      # IMPORTED_LOCATION_DEBUG "${QGIS_${_component}_LIBRARY_DEBUG}") endif()
    endif()
  endif()
...
if(QGIS_INCLUDE_DIR)
  ...
  string(REGEX REPLACE "^#define VERSION +\"([0-9]+\\.[0-9]+\\.[0-9]+).*$"
                       "\\1" QGIS_VERSION_STRING "${_qgsversion_str}")
endif()
...
foreach(_component ${QGIS_FIND_COMPONENTS})
  if(${_component} STREQUAL "Python")
    ...
    set_target_properties(QGIS::Python PROPERTIES PYTHON_MODULE_DIR
                                                  ${QGIS_PYTHON_MODULE_DIR})
  else()
