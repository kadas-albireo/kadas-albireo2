...
if(MSVC)
  ...
  install(FILES "${VCPKG_BASE_DIR}/tools/ffmpeg/ffmpeg.exe" DESTINATION "opt/ffmpeg")
  install(FILES "${VCPKG_BASE_DIR}/tools/ffmpeg/ffprobe.exe" DESTINATION "opt/ffmpeg")
else()
