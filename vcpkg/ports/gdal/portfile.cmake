vcpkg_from_github(
  ...
  "v${VERSION}"
  SHA512
  fccdcf484bdc833dc5f0d6ad1fce9d152fa8b861cf23b634400d8bf7fd97d2c33a6b87050538c5a6c896d4ba870469134521cc44fdad3e071adffbf29329cb9b
  HEAD_REF
  master
  PATCHES
...
# dependencies provided via vpcpkg. "core" is used for a dependency which must
# be enabled to avoid vendored lib.
vcpkg_check_features(
  ...
  qhull
  GDAL_USE_QHULL
  # core             GDAL_USE_SHAPELIB  #
  # https://github.com/OSGeo/gdal/issues/5711,
  # https://github.com/microsoft/vcpkg/issues/16041
  core
...
# https://github.com/OSGeo/gdal/pull/5941
...
if("python" IN_LIST FEATURES)
  if(VCPKG_TARGET_IS_OSX)
    ...
    foreach(macho_file IN LISTS macho_files)
      ...
      # package (not yet installed) path Will be overwritten by
