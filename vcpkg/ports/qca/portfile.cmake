# This portfile adds the Qt Cryptographic Arcitecture Changes to the original
# build: No -qt5 suffix, which is recommended just for Linux Output directories
# according to vcpkg Updated certstore. See certstore.pem in the output dirs
#
...
vcpkg_from_github(
  ...
  "v${VERSION}"
  SHA512
  de06173aaea32aac19a24510b5dbb4bb79681217eb1e4256de36db9f7158ad485fa450ffba5e13c12a0425866923b54f9b4d6164d0eaf659fdf40e458f5ee017
  PATCHES
...
# According to: https://www.openssl.org/docs/faq.html#USER16 it is up to
# developers or admins to maintain CAs. So we do it here:
...
vcpkg_execute_required_process(
  COMMAND
  "${PERL}"
  "${CMAKE_CURRENT_LIST_DIR}/mk-ca-bundle.pl"
  -n
