function(vcpkg_get_rust OUT)
  ...
  set(download_urls
      "https://raw.githubusercontent.com/rust-lang/rustup/refs/tags/${rustup_version}/rustup-init.sh"
  )
  set(download_filename "rustup-${rustup_version}-x64")
  set(download_sha512
      2482d1ca4b052f4452e06a43c472a2cf5430b4ff5e4bb1e80bb65608ca581c191e12cf85f07115ce75628f30b5e0ca09c9c5e74711111ed638f6d550c52ac725
  )
  ...
  if(NOT CARGO)
    ...
    vcpkg_execute_in_download_mode(
      ...
      "${BASH}"
      -c
      "${rustup_path} -y --profile minimal --default-toolchain=${version}"
      WORKING_DIRECTORY
      "${tool_path}"
      OUTPUT_FILE
      "${CURRENT_BUILDTREES_DIR}/rustup-${TARGET_TRIPLET}-out.log"
      ERROR_FILE
      "${CURRENT_BUILDTREES_DIR}/rustup-${TARGET_TRIPLET}-err.log"
      RESULT_VARIABLE
      error_code
    )
    if(error_code)
