...
KadasMapGridLayer::Renderer::Renderer(KadasMapGridLayer *layer, QgsRenderContext &rendererContext)
  : QgsMapLayerRenderer( layer->id(), &rendererContext )
  , mRenderGridConfig( layer->mGridConfig )
  , mRenderOpacity( layer->opacity() )
{}

bool KadasMapGridLayer::Renderer::render()
{
...
void KadasMapGridLayer::Renderer::drawCrsGrid(const QString &crs, double segmentLength, QgsCoordinateFormatter::Format format, int precision, QgsCoordinateFormatter::FormatFlags flags)
{
...
void KadasMapGridLayer::Renderer::adjustZoneLabelPos(QPointF &labelPos, const QPointF &maxLabelPos, const QRectF &visibleExtent)
{
...
QRect KadasMapGridLayer::Renderer::computeScreenExtent(const QgsRectangle &mapExtent, const QgsMapToPixel &mapToPixel)
{
...
void KadasMapGridLayer::Renderer::drawMgrsGrid()
{
  const QVariantMap &renderFlags = renderContext()->customProperties();
...
void KadasMapGridLayer::Renderer::drawGridLabel(const QPointF &pos, const QString &text, const QFont &font, const QColor &bufferColor)
{
  QPainterPath path;
