...
osgQtViewerWidget::osgQtViewerWidget( osgViewer::ViewerBase *viewer ) :
  _viewer( viewer )
{
  if ( !_viewer.valid() )
  {
...
osgQtViewerWidget::~osgQtViewerWidget()
{
  _timer.stop();
  if ( _viewer.valid() )
  {
...
void osgQtViewerWidget::installFrameTimer()
{
...
void osgQtViewerWidget::createViewer()
{
...
void osgQtViewerWidget::reconfigure( osgViewer::View *view )
{
  if ( !_gc.valid() )
  {
    ...
    traits->inheritedWindowData = new osgQtGraphicsWindow::WindowData( this );

    _gc = new osgQtGraphicsWindow( traits.get() );
...
void osgQtViewerWidget::paintEvent( QPaintEvent *e )
{
  Q_UNUSED( e );
