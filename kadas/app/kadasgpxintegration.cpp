...
KadasGpxIntegration::KadasGpxIntegration( QAction *actionWaypoint, QAction *actionRoute, QAction *actionExportGpx, QAction *actionImportGpx, QObject *parent )
  : QObject( parent )
{
  connect( actionWaypoint, &QAction::triggered, this, [ = ]( bool active ) { toggleCreateItem( active, new KadasWayPointInterface() ); } );
  connect( actionRoute, &QAction::triggered, this, [ = ]( bool active ) { toggleCreateItem( active, new KadasRouteInterface() ); } );
...
void KadasGpxIntegration::toggleCreateItem( bool active, KadasMapItemInterface *interface )
{
