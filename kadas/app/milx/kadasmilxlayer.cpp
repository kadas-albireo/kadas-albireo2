...
//      bool omitSinglePoint = flags.contains( "globe" ) || flags.contains( "kml" );
      ...
      QRect screenExtent = KadasMilxItem::computeScreenExtent( mRendererContext.coordinateTransform().transform( mRendererContext.mapExtent() ), mRendererContext.mapToPixel() );
