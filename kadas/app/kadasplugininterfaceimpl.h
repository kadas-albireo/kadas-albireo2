...
public:
  ...
  virtual void addCustomActionForLayerType(QAction *action, QString menu,
                                           Qgis::LayerType type,
                                           bool allLayers) override;
  virtual void addCustomActionForLayer(QAction *action,
                                       QgsMapLayer *layer) override;
  ...
  virtual Qgs3DMapCanvas *createNewMapCanvas3D(
      const QString &name,
      Qgis::SceneMode sceneMode = Qgis::SceneMode::Local) override;
#else
  ...
  virtual QList<QgsMapLayer *>
  editableLayers(bool modified = false) const override;
  ...
  virtual QMenu *projectMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::PROJECT_MENU);
  }
  virtual QMenu *editMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::EDIT_MENU);
  }
  virtual QMenu *viewMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::VIEW_MENU);
  }
  virtual QMenu *layerMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::LAYER_MENU);
  }
  virtual QMenu *newLayerMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::NEWLAYER_MENU);
  }
  virtual QMenu *addLayerMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::ADDLAYER_MENU);
  }
  virtual QMenu *settingsMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::SETTINGS_MENU);
  }
  virtual QMenu *pluginMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::PLUGIN_MENU);
  }
  virtual QMenu *rasterMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::RASTER_MENU);
  }
  virtual QMenu *databaseMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::DATABASE_MENU);
  }
  virtual QMenu *vectorMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::VECTOR_MENU);
  }
  virtual QMenu *webMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::WEB_MENU);
  }
  ...
  virtual QMenu *windowMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::WINDOW_MENU);
  }
  virtual QMenu *helpMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::HELP_MENU);
  }
  virtual QMenu *pluginHelpMenu() override {
    return getClassicMenu(ActionClassicMenuLocation::HELP_MENU);
  }
  ...
  virtual void addPluginToDatabaseMenu(const QString &name,
                                       QAction *action) override;
  virtual void removePluginDatabaseMenu(const QString &name,
                                        QAction *action) override;
  virtual void addPluginToRasterMenu(const QString &name,
                                     QAction *action) override;
  virtual void removePluginRasterMenu(const QString &name,
                                      QAction *action) override;
  virtual void addPluginToVectorMenu(const QString &name,
                                     QAction *action) override;
  virtual void removePluginVectorMenu(const QString &name,
                                      QAction *action) override;
  virtual void addPluginToWebMenu(const QString &name,
                                  QAction *action) override;
  virtual void removePluginWebMenu(const QString &name,
                                   QAction *action) override;
  ...
  virtual QgsVectorLayer *addVectorLayer(const QString &vectorLayerPath,
                                         const QString &baseName,
                                         const QString &providerKey) override;
  virtual QgsRasterLayer *
  addRasterLayer(const QString &rasterLayerPath,
                 const QString &baseName = QString()) override;
  virtual QgsRasterLayer *addRasterLayer(const QString &url,
                                         const QString &layerName,
                                         const QString &providerKey) override;
  virtual QgsVectorTileLayer *
  addVectorTileLayer(const QString &url, const QString &baseName) override;
  virtual QgsPointCloudLayer *
  addPointCloudLayer(const QString &url, const QString &baseName,
                     const QString &providerKey) override;
#if _QGIS_VERSION_INT >= 33400
  virtual QgsTiledSceneLayer *
  addTiledSceneLayer(const QString &url, const QString &baseName,
                     const QString &providerKey) override;
#endif

  virtual QgsVectorLayer *
  addVectorLayerQuiet(const QString &vectorLayerPath, const QString &baseName,
                      const QString &providerKey) override;
  virtual QgsRasterLayer *
  addRasterLayerQuiet(const QString &url, const QString &layerName,
                      const QString &providerKey) override;
  virtual QgsVectorTileLayer *
  addVectorTileLayerQuiet(const QString &url, const QString &baseName) override;
  virtual QgsPointCloudLayer *
  addPointCloudLayerQuiet(const QString &url, const QString &baseName,
                          const QString &providerKey) override;

  virtual QgsMeshLayer *addMeshLayer(const QString &url,
                                     const QString &baseName,
                                     const QString &providerKey) override;
  ...
  virtual void showLayerProperties(QgsMapLayer *l,
                                   const QString &page = QString()) override;
  virtual QDialog *
  showAttributeTable(QgsVectorLayer *l,
                     const QString &filterExpression = QString()) override;
  virtual bool openFeatureForm(QgsVectorLayer *l, QgsFeature &f,
                               bool updateFeatureOnly = false,
                               bool showModal = true) override;
  virtual QgsAttributeDialog *getFeatureForm(QgsVectorLayer *l,
                                             QgsFeature &f) override;
  ...
  virtual void openURL(const QString &url,
                       bool useQgisDocDirectory = true) SIP_DEPRECATED override;
  ...
  openLayoutDesigner(QgsMasterLayoutInterface *layout) override;

  virtual void
  registerCustomDropHandler(QgsCustomDropHandler *handler) override;
  virtual void
  unregisterCustomDropHandler(QgsCustomDropHandler *handler) override;
  virtual void
  registerCustomLayoutDropHandler(QgsLayoutCustomDropHandler *handler) override;
  virtual void unregisterCustomLayoutDropHandler(
      QgsLayoutCustomDropHandler *handler) override;

  virtual bool
  registerMainWindowAction(QAction *action,
                           const QString &defaultShortcut) override;
  virtual bool unregisterMainWindowAction(QAction *action) override;

  // Unsupported QGIS interface
  virtual QMap<QString, QVariant> defaultStyleSheetOptions() override {
  ...
  virtual void
  saveStyleSheetOptions(const QMap<QString, QVariant> &opts) override {}
  virtual QgsAdvancedDigitizingDockWidget *cadDockWidget() override {
    return nullptr;
  }
  virtual QList<QgsMapDecoration *> activeDecorations() override {
    return QList<QgsMapDecoration *>();
  }

  virtual QToolBar *fileToolBar() override { return dummyToolbar(); }
  virtual QToolBar *layerToolBar() override { return dummyToolbar(); }
  virtual QToolBar *dataSourceManagerToolBar() override {
    return dummyToolbar();
  }
  ...
  virtual QAction *addToolBarWidget(QWidget *widget SIP_TRANSFER) override {
    return nullptr;
  }
  virtual void removeToolBarIcon(QAction *qAction) override {}
  virtual QAction *
  addRasterToolBarWidget(QWidget *widget SIP_TRANSFER) override {
    return nullptr;
  }
  ...
  virtual QAction *
  addVectorToolBarWidget(QWidget *widget SIP_TRANSFER) override {
    return nullptr;
  }
  ...
  virtual QAction *
  addDatabaseToolBarWidget(QWidget *widget SIP_TRANSFER) override {
    return nullptr;
  }
  ...
  virtual QAction *addWebToolBarWidget(QWidget *widget SIP_TRANSFER) override {
    return nullptr;
  }
  virtual void removeWebToolBarIcon(QAction *qAction) override {}
  virtual QToolBar *addToolBar(const QString &name) SIP_FACTORY override {
    return nullptr;
  }
  virtual void addToolBar(QToolBar *toolbar SIP_TRANSFER,
                          Qt::ToolBarArea area = Qt::TopToolBarArea) override {}
  ...
  virtual QAction *actionToggleSelectedLayersIndependently() override {
    return nullptr;
  }
  ...
  virtual QAction *actionRectangle3PointsProjected() override {
    return nullptr;
  }
  virtual QAction *actionRegularPolygon2Points() override { return nullptr; }
  virtual QAction *actionRegularPolygonCenterPoint() override {
    return nullptr;
  }
  virtual QAction *actionRegularPolygonCenterCorner() override {
    return nullptr;
  }
  ...
  virtual void
  registerLocatorFilter(QgsLocatorFilter *filter SIP_TRANSFER) override {}
  virtual void deregisterLocatorFilter(QgsLocatorFilter *filter) override {}
  virtual void invalidateLocatorResults() override {}
  virtual bool
  askForDatumTransform(QgsCoordinateReferenceSystem sourceCrs,
                       QgsCoordinateReferenceSystem destinationCrs) override {
    return false;
  }
  ...
  virtual void
  showOptionsDialog(QWidget *parent = nullptr,
                    const QString &currentPage = QString()) override;

  virtual void addDockWidget(Qt::DockWidgetArea area,
                             QDockWidget *dockwidget) override {}
  virtual void removeDockWidget(QDockWidget *dockwidget) override {}

  virtual void registerMapLayerConfigWidgetFactory(
      QgsMapLayerConfigWidgetFactory *factory) override {}
  virtual void unregisterMapLayerConfigWidgetFactory(
      QgsMapLayerConfigWidgetFactory *factory) override {}
  virtual void
  registerOptionsWidgetFactory(QgsOptionsWidgetFactory *factory) override {}
  virtual void
  unregisterOptionsWidgetFactory(QgsOptionsWidgetFactory *factory) override {}

  virtual void locatorSearch(const QString &searchText) override {}
  virtual QgsLayerTreeRegistryBridge::InsertionPoint
  layerTreeInsertionPoint() override;

  virtual void
  showProjectPropertiesDialog(const QString &currentPage = QString()) override {
  };
  virtual void
  addTabifiedDockWidget(Qt::DockWidgetArea area, QDockWidget *dockwidget,
                        const QStringList &tabifyWith = QStringList(),
                        bool raiseTab = false) override {};
  virtual void registerProjectPropertiesWidgetFactory(
      QgsOptionsWidgetFactory *factory) override {};
  virtual void unregisterProjectPropertiesWidgetFactory(
      QgsOptionsWidgetFactory *factory) override {};
  virtual void
  registerDevToolWidgetFactory(QgsDevToolWidgetFactory *factory) override {};
  virtual void
  unregisterDevToolWidgetFactory(QgsDevToolWidgetFactory *factory) override {};
  virtual void showApiDocumentation(
      Qgis::DocumentationApi api = Qgis::DocumentationApi::PyQgis,
      Qgis::DocumentationBrowser browser =
          Qgis::DocumentationBrowser::DeveloperToolsPanel,
      const QString &object = QString(),
      const QString &module = QString()) override;
  virtual void registerApplicationExitBlocker(
      QgsApplicationExitBlockerInterface *blocker) override {};
  virtual void unregisterApplicationExitBlocker(
      QgsApplicationExitBlockerInterface *blocker) override {};
  virtual void
  registerMapToolHandler(QgsAbstractMapToolHandler *handler) override {};
  virtual void
  unregisterMapToolHandler(QgsAbstractMapToolHandler *handler) override {};
  virtual void registerCustomProjectOpenHandler(
      QgsCustomProjectOpenHandler *handler) override {};
  virtual void unregisterCustomProjectOpenHandler(
      QgsCustomProjectOpenHandler *handler) override {};
  ...
  QMenu *getClassicMenu(ActionClassicMenuLocation classicMenuLocation,
                        const QString &customName = QString()) override;
  QMenu *getSubMenu(QMenu *menu, const QString &submenuName) override;
  QWidget *getRibbonWidget() override;
  QWidget *getRibbonTabWidget(ActionRibbonTabLocation ribbonTabLocation,
                              const QString &customName) override;

  //! Generic action adder
  void addAction(QAction *action, ActionClassicMenuLocation classicMenuLocation,
                 ActionRibbonTabLocation ribbonTabLocation,
                 const QString &customName = QString(),
                 QgsMapTool *associatedMapTool = nullptr) override;
  void addActionMenu(const QString &text, const QIcon &icon, QMenu *menu,
  ...
  void removeAction(QAction *action,
                    ...
                    const QString &customName = QString(),
                    QgsMapTool *associatedMapTool = nullptr) override;
  void removeActionMenu(QMenu *menu,
                        ActionClassicMenuLocation classicMenuLocation,
                        ActionRibbonTabLocation ribbonTabLocation,
                        const QString &customName = QString()) override;
