...
#ifndef KADASMESH3DSYMBOLWIDGET_H
#define KADASMESH3DSYMBOLWIDGET_H
...
class KadasMesh3DSymbolWidget : public QWidget,
                                private Ui::QgsMesh3dPropsWidget {
  Q_OBJECT
public:
  explicit KadasMesh3DSymbolWidget(QgsMeshLayer *meshLayer,
