...
Kadas3DNavigationWidget::Kadas3DNavigationWidget( Kadas3DMapCanvas *parent ) : QWidget( parent )
{
  setupUi( this );
...
void Kadas3DNavigationWidget::resizeEvent( QResizeEvent *ev )
{
...
void Kadas3DNavigationWidget::hideEvent( QHideEvent *ev )
{
  QWidget::hideEvent( ev );
  emit sizeChanged( QSize( 0, 0 ) );
}

void Kadas3DNavigationWidget::showEvent( QShowEvent *ev )
{
