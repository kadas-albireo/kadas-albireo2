...
#include "kadas/app/3d/kadaslightswidget.h"
  ...
  : QWidget( parent )
{
  ...
  connect( mLightsListView->selectionModel(), &QItemSelectionModel::selectionChanged, this, &KadasLightsWidget::selectedLightChanged );
  ...
  connect( addPointLight, &QAction::triggered, this, &KadasLightsWidget::onAddLight );
  ...
  connect( btnRemoveLight, &QToolButton::clicked, this, &KadasLightsWidget::onRemoveLight );

  connect( spinPositionX, qOverload<double>( &QDoubleSpinBox::valueChanged ), this, &KadasLightsWidget::updateCurrentLightParameters );
  connect( spinPositionY, qOverload<double>( &QDoubleSpinBox::valueChanged ), this, &KadasLightsWidget::updateCurrentLightParameters );
  connect( spinPositionZ, qOverload<double>( &QDoubleSpinBox::valueChanged ), this, &KadasLightsWidget::updateCurrentLightParameters );
  connect( spinIntensity, qOverload<double>( &QDoubleSpinBox::valueChanged ), this, &KadasLightsWidget::updateCurrentLightParameters );
  connect( btnColor, &QgsColorButton::colorChanged, this, &KadasLightsWidget::updateCurrentLightParameters );
  connect( spinA0, qOverload<double>( &QDoubleSpinBox::valueChanged ), this, &KadasLightsWidget::updateCurrentLightParameters );
  connect( spinA1, qOverload<double>( &QDoubleSpinBox::valueChanged ), this, &KadasLightsWidget::updateCurrentLightParameters );
  connect( spinA2, qOverload<double>( &QDoubleSpinBox::valueChanged ), this, &KadasLightsWidget::updateCurrentLightParameters );
...
QList<QgsLightSource *> KadasLightsWidget::lightSources()
{
...
int KadasLightsWidget::directionalLightCount() const
{
  return mLightsModel->directionalLights().count();
}

int KadasLightsWidget::lightSourceCount() const
{
...
void KadasLightsWidget::showSettingsForPointLight( const QgsPointLightSettings &light )
{
...
void KadasLightsWidget::showSettingsForDirectionalLight( const QgsDirectionalLightSettings &light )
{
...
void KadasLightsWidget::updateCurrentDirectionalLightParameters()
{
...
void KadasLightsWidget::onAddLight()
{
...
void KadasLightsWidget::onDirectionChange()
{
