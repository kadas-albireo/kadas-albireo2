...
KadasAmbientOcclusionSettingsWidget::KadasAmbientOcclusionSettingsWidget( QWidget *parent )
  : QWidget( parent )
{
  setupUi( this );
...
void KadasAmbientOcclusionSettingsWidget::setAmbientOcclusionSettings( const QgsAmbientOcclusionSettings &settings )
{
...
QgsAmbientOcclusionSettings KadasAmbientOcclusionSettingsWidget::toAmbientOcclusionSettings()
{
