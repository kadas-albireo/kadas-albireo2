...
public:
  KadasPointItem(const QgsCoordinateReferenceSystem &crs,
                 KadasGeometryItem::IconType icon =
                     KadasGeometryItem::IconType::ICON_CIRCLE);
