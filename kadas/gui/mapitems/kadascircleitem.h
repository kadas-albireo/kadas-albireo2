...
public:
  KadasCircleItem(const QgsCoordinateReferenceSystem &crs,
                  bool geodesic = false);
  ...
  Qgis::GeometryType geometryType() const override {
...
private:
  ...
  void computeCircle(const KadasItemPos &center, const KadasItemPos &ringpos,
                     QgsMultiSurface *multiGeom);
  void computeGeoCircle(const KadasItemPos &center, const KadasItemPos &ringpos,
                        QgsMultiSurface *multiGeom);
};
