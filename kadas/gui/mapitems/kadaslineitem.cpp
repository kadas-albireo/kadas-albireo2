...
{
  KadasLineItem *item = new KadasLineItem( crs(), mGeodesic );
...
void KadasLineItem::writeXmlPrivate( QDomElement &element ) const
{
...
void KadasLineItem::readXmlPrivate( const QDomElement &element )
{
