...
class KADAS_GUI_EXPORT KadasAttributeTableDialog : public QDockWidget
{
  ...
  public:
    static const inline QgsSettingsEntryEnumFlag<Qt::DockWidgetArea> *settingsAttributeTableLocation
      = new QgsSettingsEntryEnumFlag<Qt::DockWidgetArea>( QStringLiteral( "attribute-dock-location" ), KadasSettingsTree::sTreeKadas, Qt::DockWidgetArea::NoDockWidgetArea ) SIP_SKIP;
