...
KadasRemoteDataSearchProvider::KadasRemoteDataSearchProvider( const QString &remoteDataSearchUrl, QgsMapCanvas *mapCanvas )
  : KadasSearchProvider( mapCanvas ), mRemoteDataSearchUrl( remoteDataSearchUrl )
{
  mReplyFilter = 0;
