...
MilXServerRequest MILX_REQUEST_GET_CONTROL_POINTS
  = 14; // {MILX_REQUEST_GET_CONTROL_POINTS, SymbolXml:QString, Points:QList<QPoint>, Attributes:QList<QPair<int, double>>, isCorridor:bool, symbolSize:int, lineWidth:int, workMode: int}

MilXServerRequest MILX_REQUEST_APPEND_POINT
  = 20; // {MILX_REQUEST_APPEND_POINT, VisibleExtent:QRect, dpi:int, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, NewPoint:QPoint, symbolSize:int, lineWidth:int, workMode: int}
MilXServerRequest MILX_REQUEST_INSERT_POINT
  = 21; // {MILX_REQUEST_INSERT_POINT, VisibleExtent:QRect, dpi:int, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, NewPoint:QPoint, symbolSize:int, lineWidth:int, workMode: int}
MilXServerRequest MILX_REQUEST_MOVE_POINT
  = 22; // {MILX_REQUEST_MOVE_POINT, VisibleExtent:QRect, dpi:int, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, index:int, NewPos:QPoint, symbolSize:int, lineWidth:int, workMode: int}
MilXServerRequest MILX_REQUEST_MOVE_ATTRIBUTE_POINT
  = 23; // {MILX_REQUEST_MOVE_ATTRIBUTE_POINT, VisibleExtent:QRect, dpi:int, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, index:int, NewPos:QPoint, symbolSize:int, lineWidth:int, workMode: int}
MilXServerRequest MILX_REQUEST_CAN_DELETE_POINT
  = 24; // {MILX_REQUEST_CAN_DELETE_POINT, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, index:int, symbolSize:int, lineWidth:int, workMode: int}
MilXServerRequest MILX_REQUEST_DELETE_POINT
  = 25; // {MILX_REQUEST_DELETE_POINT, VisibleExtent:QRect, dpi:int, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, index:int, symbolSize:int, lineWidth:int, workMode: int}
MilXServerRequest MILX_REQUEST_EDIT_SYMBOL
  = 26; // {MILX_REQUEST_EDIT_SYMBOL, VisibleExtent:QRect, dpi:int, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, symbolSize:int, lineWidth:int, workMode: int, wid:WId}
...
MilXServerRequest MILX_REQUEST_UPDATE_SYMBOL
  = 30; // {MILX_REQUEST_UPDATE_SYMBOL, VisibleExtent:QRect, dpi:int, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, symbolSize:int, lineWidth:int, workMode: int, returnPoints:bool}
MilXServerRequest MILX_REQUEST_UPDATE_SYMBOLS
  = 31; // {MILX_REQUEST_UPDATE_SYMBOLS, VisibleExtent:QRect, dpi:int, symbolSize:int, lineWidth:int, workMode: int, nSymbols:int, SymbolXml1:QString, Points1:QList<QPoint>, ControlPoints1:QList<int>, Attributes1:QList<QPair<int,double>>, finalized1:bool, colored1:bool, SymbolXml2:QString, Points2:QList<QPoint>, ControlPoints2:QList<int>, Attributes2:QList<QPair<int,double>>, finalized2:bool, colored2:bool, ...}

MilXServerRequest MILX_REQUEST_HIT_TEST
  = 40; // {MILX_REQUEST_HIT_TEST, SymbolXml:QString, Points:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, finalized:bool, colored:bool, clickPos:QPoint, symbolSize:int, lineWidth:int, workMode: int}
MilXServerRequest MILX_REQUEST_PICK_SYMBOL
  = 41; // {MILX_REQUEST_PICK_SYMBOL, ClickPos:QPoint, symbolSize:int, lineWidth:int, workMode: int, nSymbols:int, SymbolXml1:QString, Points1:QList<QPoint>, ControlPoints1:QList<int>, Attributes1:QList<QPair<int,double>>, finalized1:bool, colored1:bool, SymbolXml2:QString, Points2:QList<QPoint>, ControlPoints2:QList<int>, Attributes2:QList<QPair<int,double>>, finalized2:bool, colored2:bool, ...}
...
MilXServerReply MILX_REPLY_GET_SYMBOLS_METADATA
  = 111; // {MILX_REPLY_GET_SYMBOLS_METADATA, count:int, Name1:QString, MilitaryName1:QString, SvgXML1:QByteArray, HasVariablePoints1:bool, MinPointCount1:int, SymbolType1:QString, Name2:QString, MilitaryName2:QString, SvgXML2:QByteArray, HasVariablePoints2:bool, MinPointCount2:int, SymbolType2:QString, ...}
...
MilXServerReply MILX_REPLY_MOVE_ATTRIBUTE_POINT
  = 123; // {MILX_REPLY_MOVE_ATTRIBUTE_POINT, SvgString:QByteArray, Offset:QPoint, AdjustedPoints:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>}
...
MilXServerReply MILX_REPLY_EDIT_SYMBOL
  = 126; // {MILX_REPLY_EDIT_SYMBOL, SymbolXml:QString, MilitaryName:QString, SvgString:QByteArray, Offset:QPoint, AdjustedPoints:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>}
...
MilXServerReply MILX_REPLY_UPDATE_SYMBOL
  = 130; // {MILX_REPLY_UPDATE_SYMBOL, SvgXml:QByteArray, Offset:QPoint[, AdjustedPoints:QList<QPoint>, ControlPoints:QList<int>, Attributes:QList<QPair<int,double>>, AttributePoints:QList<QPair<int,QPoint>>]} // Last four depending on whether returnPoints is true in the request
