...
class KADAS_GUI_EXPORT KadasFloatingInputWidgetField : public QLineEdit {
  Q_OBJECT
public:
  KadasFloatingInputWidgetField(int id, int decimals, double min, double max,
...
public:
  ...
  int addInputField(const QString &label, KadasFloatingInputWidgetField *widget,
                    const QString &suffix, bool initiallyfocused = false);
