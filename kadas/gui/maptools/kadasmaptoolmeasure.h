...
class KADAS_GUI_EXPORT KadasMeasureWidget : public KadasMapItemEditor
{
  ...
  public:
    ...
    static const inline QgsSettingsEntryEnumFlag<AzimuthNorth> *settingsLastAzimuthNorth = new QgsSettingsEntryEnumFlag<AzimuthNorth>(QStringLiteral("last-azimuth-north"), KadasSettingsTree::sTreeApp, AzimuthNorth::AzimuthGeoNorth );
