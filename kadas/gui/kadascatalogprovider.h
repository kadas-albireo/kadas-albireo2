...
class KADAS_GUI_EXPORT KadasCatalogProvider : public QObject
{
  ...
  protected:
    ...
    bool parseWMSLayerCapabilities( const QDomNode &layerItem, const QString &title, const QStringList &imgFormats, const QStringList &parentCrs, const QString &url, const QString &layerInfoUrl, QMimeData *&mimeData ) const;
