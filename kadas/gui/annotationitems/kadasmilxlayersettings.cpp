...
bool KadasMilxLayerSettings::overrideEnabled( const QgsMapLayer *layer )
{
  if ( !layer )
    return false;
...
void KadasMilxLayerSettings::setOverrideEnabled( QgsMapLayer *layer, bool enabled )
{
  if ( !layer )
    return;
...
KadasMilxSymbolSettings KadasMilxLayerSettings::layerSettings( const QgsMapLayer *layer )
{
...
void KadasMilxLayerSettings::setLayerSettings( QgsMapLayer *layer, const KadasMilxSymbolSettings &s )
{
  if ( !layer )
    return;
...
KadasMilxSymbolSettings KadasMilxLayerSettings::resolve( const QgsMapLayer *layer )
{
...
KadasMilxSymbolSettings KadasMilxLayerSettings::resolve( const QgsRenderContext &context )
{
