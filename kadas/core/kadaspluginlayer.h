...
public:
  KadasPluginLayer(const QString &layerType,
  ...
  bool writeSymbology(
      QDomNode &node, QDomDocument &doc, QString &errorMessage,
  ...
  bool readSymbology(const QDomNode &node, QString &errorMessage,
                     ...
                     StyleCategories categories = AllStyleCategories) override {
    return true;
  }
  ...
  public:
    IdentifyResult(const QString &featureName,
  ...
  virtual QList<KadasPluginLayer::IdentifyResult>
  identify(const QgsPointXY &mapPos, const QgsMapSettings &mapSettings) {
    return QList<IdentifyResult>();
  }
...
class KADAS_CORE_EXPORT KadasPluginLayerType : public QObject,
                                               public QgsPluginLayerType {
public:
  KadasPluginLayerType(const QString &name) : QgsPluginLayerType(name) {}

  virtual void addLayerTreeMenuActions(QMenu *menu,
                                       QgsPluginLayer *layer) const {};
