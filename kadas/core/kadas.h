...
class KADAS_CORE_EXPORT Kadas
{
  public:
    ...
    static const inline QgsSettingsEntryBool *settingsGdalUnsetEnvVar = new QgsSettingsEntryBool( QStringLiteral( "unset-env-vars" ), sTreeGdalProxy, false, QStringLiteral( "this will be used to determine if env vars should be unset." ) ) SIP_SKIP;
