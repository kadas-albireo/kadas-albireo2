...
try:
    ...
    KadasAnnotationItemController.__virtual_methods__ = ['populateContextMenu', 'onDoubleClick', 'representativeGeometry', 'liveRepaintOnEdit', 'symbolPreviewWhileDrawing', 'isEmpty', 'hitTest', 'intersects', 'applyPersistedStyle', 'persistStyle', 'createStyleEditor', 'generateShadows', 'shadowIds', 'setShadowIds']
