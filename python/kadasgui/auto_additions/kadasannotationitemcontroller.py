...
try:
    ...
    KadasAnnotationItemController.__virtual_methods__ = ['populateContextMenu', 'onDoubleClick', 'representativeGeometry', 'liveRepaintOnEdit', 'symbolPreviewWhileDrawing', 'isEmpty', 'hitTest', 'intersects', 'tooltip', 'applyPersistedStyle', 'persistStyle', 'createStyleEditor', 'generateShadows', 'shadowIds', 'setShadowIds']
