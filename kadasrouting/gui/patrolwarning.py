...
class PatrolWarning(BASE, WIDGET):
    def __init__(self, parent=None):
        ...
        content_de = {
            "title": "Warnung",
            "description": "Die Berechnung der Patrouillen-Route von Punkt {start} nach Punkt {end} ist fehlgeschlagen. Bitte versuchen Sie eine der folgenden Optionen:",
            # TODO: Use a list
            ...
            "third_item": "Wenn das Problem auch bei einem kleineren klar definierten Gebiet bestehen bleibt, ist der Algorithmus in dieser Version nicht in der Lage eine Verbindung für mindestens einen der eingeschlossenen Knotenpunkte zu finden und die Patrouille kann für dieses Gebiet nicht berechnet werden.",
        }
        content_fr = {
            "title": "Atencion",
            "description": "Le calcul de l'itinéraire de patrouille a échoué du point {start} au point {end}. Veuillez essayer l'une des options suivantes :",
            # TODO: Use a list
            ...
            "third_item": "Si le problème persiste même pour une zone plus petite et bien définie, cela signifie que l'algorithme est incapable de trouver une connexion pour au moins un des nœuds inclus et que la patrouille ne peut pas être calculée pour cette zone.",
        }
        content_it = {
            "title": "Attenzione",
            "description": "Il calcolo del percorso di ronda non è riuscito dal punto {start} al punto {end}. Prova una delle seguenti opzioni:",
            # TODO: Use a list
            ...
            "third_item": "Se il problema persiste anche per un'area più piccola e ben definita, allora l'algoritmo non è in grado di trovare una connessione per almeno uno dei nodi racchiusi e la ronda non può essere calcolata per quest'area.",
        }
