...
from kadas.kadasgui import KadasItemLayer, KadasItemLayerRegistry, KadasMapRect
...
class KadasGpkgExport(KadasGpkgExportBase):
    ...
    def __removeUnselectedProjectLayers(self, doc):
        ...
        unselected_layer_ids = (
            self.kadasGpkgExportDialog.unselectedProjectLayers().keys()
        )
        ...
        for legendGroupEl in doc.iterfind("layer-tree-group"):
            self.__removeUnselectedProjectLayersGroups(
                legendGroupEl, unselected_layer_ids
            )

    def __removeUnselectedProjectLayersGroups(
        self, legendGroupEl, unselected_layer_ids
    ):
        ...
        for nestedLegendGroupEl in legendGroupEl.iterfind("layer-tree-group"):
            self.__removeUnselectedProjectLayersGroups(
                nestedLegendGroupEl, unselected_layer_ids
            )

            # Remove group if empty
            if not nestedLegendGroupEl.findall(
                "layer-tree-group"
            ) and not nestedLegendGroupEl.findall("layer-tree-layer"):
